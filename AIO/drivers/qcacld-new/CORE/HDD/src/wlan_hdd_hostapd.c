...
static inline void wlan_cfg80211_ch_switch_notify(struct net_device *dev,
...
static inline void wlan_cfg80211_ch_switch_started_notify(struct net_device *dev,
